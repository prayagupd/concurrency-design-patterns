 ...
 * @author Tomas Zezula
 *
 * Proves that the implementation of org.zezutom.concurrencypatterns.org.zezutom.concurrencypatterns.activeobject.ThreadUnsafeServer
 * is NOT thread-safe. The tests "pass" in a a sense that the actual results differ from
 * the expected values.
 */
public class ThreadUnsafeServerMultiThreadedTest {
    ...
    public static void init() {
        ...
        server = new ThreadUnsafeServer(INITIAL_VALUE);
