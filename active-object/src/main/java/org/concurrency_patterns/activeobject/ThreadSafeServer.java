 ...
 * @author Tomas Zezula
 *
 * Implements the org.zezutom.concurrencypatterns.org.zezutom.concurrencypatterns.activeobject.Server in a way that is suitable
 ...
 */
public class ThreadSafeServer implements Server {
    ...
    public ThreadSafeServer(long value) {
        this.value = value;
